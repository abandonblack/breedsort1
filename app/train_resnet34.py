...
from app.model_resnet34 import build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="训练 ResNet34（无注意力，Oxford-IIIT Pet）")
    ...
    parser.add_argument("--save-path", type=Path, default=Path("artifacts/resnet34_plain.pth"))
    parser.add_argument("--history-path", type=Path, default=Path("artifacts/resnet34_plain_history.json"))
